...
error_modalMor =[0.0532, 0.0528,  0.0524, 0.0522, 0.0520,  0.0295, 0.0230,0.0213, 0.0027,  0.0025]

% results - erased 2,3,4 to empty the space
model_order    =[1,           5,     10, 20, 40, 80, 160]
error_modalMor =[0.0532, 0.0520,  0.0295, 0.0230,0.0213, 0.0027,  0.0025]
