...
% coefficient. Here we assume that the surface temperature is fixed
% Author: Aleksandar Haber, May 06, 2021

% maximal temperature
% temperature of the surface
Tmax=377    % THIS VALUE YOU CAN ADJUST USING THE EXPERIMENTAL DATA
% initial temperature
...
%Nusselt number
Nu_int=0.68+(0.670*(Ra_int)^(1/4))/((1+(0.492/Pr_int)^(9/16))^(4/9))
